...
![Sides A and B of the Phaistos disc](./src/data/phaistos_disk.png)
...
- pip install phaistos-disc
- git clone ...

## Contributions

Contributions are welcome. Fork the repo and submit a pull review.
